 ...
 if(obj.value.length==0){
	...
	function expExcel() {
		...
		if (two) {
			...
			form.action = "<%=basePath%>dataDictionary.do?editWord";
			form.method="post";
			form.submit();
			}
	}	
					...
					<table cellpadding="0" cellspacing="0" border="0"
						...
						<tr>
							...
							<td><input id="col1" class="hidden_input" type="text"
								value="${details.col2}" name="col1" readonly="readonly"
								onblur="checkNull('col1','btSpan')"> <span id="btSpan"
								class="alert_span"></span></td>
							<th>展示名称</th>
							<td><input id="col2" class="show_input" type="text"
						...
						<tr>
							<th>字段编号</th>
							<td><input id="col3" class="show_input" type="text"
								value="${details.col1}" name="col3"
								onblur="checkNull('col3','fbrSpan')"> <span id="fbrSpan"
								class="alert_span">*</span></td>
							<th>字段名称</th>
							<td><input id="col4" class="show_input" type="text"
