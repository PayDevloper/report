		...
		loginTabs = $('#loginTabs').tabs({
			...
			onSelect : function(title) {
				if (title == '输入方式') {
					...
					setTimeout(function() {
						loginComboboxName.combogrid('textbox').focus();
					}, 1);
				}
...
<div id="loginAndRegDialog" style="width: 300px;height: 180px;display: none;">
	<div id="loginTabs">
			...
			<form id="loginDatagridForm" method="post">
				<table class="tableForm">
					<tr>
						...
						<td><select id="loginDatagridName" name="name" style="display: none;width:157px;"></select></td>
					</tr>
					<tr>
						<th>密码</th>
