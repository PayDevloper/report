		...
		<div id="toolbar" class="datagrid-toolbar" style="height: auto;">
			<fieldset>
				...
				<table class="tableForm">
					...
					<tr>
						<th>创建时间</th>
						<td colspan="2"><input name="createdatetimeStart" class="easyui-datetimebox" editable="false" style="width: 150px;" />-<input name="createdatetimeEnd" class="easyui-datetimebox" editable="false" style="width: 150px;" /></td>
					</tr>
					<tr>
						<th>最后修改时间</th>
						<td><input name="modifydatetimeStart" class="easyui-datetimebox" editable="false" style="width: 150px;" />-<input name="modifydatetimeEnd" class="easyui-datetimebox" editable="false" style="width: 150px;" />
						</td>
	...
	<div id="userDialog" style="display: none;overflow: hidden;">
		<form id="userForm" method="post">
			<table class="tableForm">
				...
				<tr>
					<th>创建时间</th>
					<td><input name="createdatetime" class="easyui-datetimebox" style="width: 156px;" />
					</td>
				</tr>
				<tr>
					<th>最后修改时间</th>
					<td><input name="modifydatetime" class="easyui-datetimebox" style="width: 156px;" />
					</td>
				</tr>
				<tr>
					<th>所属角色</th>
